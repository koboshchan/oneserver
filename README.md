...
> [!NOTE]
> Other services (like your API backend or app containers) join the external `oneserver_bridge` network so Nginx can forward requests directly using their container name and port (e.g. `"forwarding": "api:8080"`).
